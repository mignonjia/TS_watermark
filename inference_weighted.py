...
delta_init_list = ['0.75', '1.0', '1.25', '1.5', '1.75', '2.0']
gamma_init_list = ['0.25'] * len(delta_init_list)
ckpt_paths = [f"ckpt/weighted_sum/init_delta_{val}.pth" for val in delta_init_list]
...
def main(args):
    ...
    for inc in range(len(ckpt_paths)): # ckpt_list 
        ...
        with open(f"eval/opt/weighted_sum_test/wm_{args.gamma}_{args.delta}_demo.json", "w") as outfile:
